...
namespace RecSys
{
    class TratamentoArquivo
    {
            ...
            protected string strPathFile = @"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug\Data_Default.txt";
            protected string destinationFileName = @"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug\Kfold-parte-{0}.txt";
            protected string destinationFileNamepasta = @"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug\Kfold-pasta-{0}";
            string diretorio = @"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug";
            public int linhasporarquivo = 0;
            private static int contador1;
            public int contadorporcento = 0;
            public int flag = 0;
            public int percentTraining, percentTest, qtdKfolds;
        ...
        public void Abrir()
...

            {
                ...
                String[] listaDeArquivos = Directory.GetFiles(diretorio, "kfold*");
                ...
                if (listaDeArquivos.Length > 0)
                {
                    ...
                    for (; numero <= 10; numero++)
                        File.Delete(@"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug\Kfold-parte-" + numero + ".txt");
        ...
        public void Alterar(int valorNum1)
            ...
            private void gerarTestTrainingSet(int tam, double tamTestSet)
            {
                ...
                string nomeDaPasta = @"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug\kfold-pasta-";
                string caminhoArquivoDestinoTest = @"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug\test.data";
                string caminhoArquivoDestinotreino = @"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug\training.data";
                DirectoryInfo dir = new DirectoryInfo(@"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug");
                ...
                for (int i = 0; i < tam; i++, num++)
                {
                    ...
                    if (listaDeArquivos.Length > 0)
                    {
                        ...
                        string destinoTest = nomeDaPasta + num + "\\test.data";
                        foreach (FileInfo f in dir.GetFiles("test.data"))
                    ...
                    // gerar treino
                    String[] listaDeArquivostreino = Directory.GetFiles(diretorio, "kfold*");
                    ...
                    if (listaDeArquivostreino.Length > 0)
                    {
                        ...
                        string destinoTraining = nomeDaPasta + num + "\\training.data";
                        foreach (FileInfo f in dir.GetFiles("training.data"))
        ...
        public void menu()
        {
            ...
            do
            {
                ...
                switch (op)
                {
                    ...
                    case 3:
                        Console.Clear();
                        Console.WriteLine("Entre com a quantidade de k folds desejada");
                        qtdKfolds = Int32.Parse(Console.ReadLine());

                        c2.Alterar(qtdKfolds); break;

                    case 4:
                        Console.Clear();
                        Console.WriteLine("Entre com a porcentagem do test desejada");
                        percentTest = Int32.Parse(Console.ReadLine());
                       
                        
                        c2.gerarTestTrainingSet(qtdKfolds, percentTest); break;
                }
