...
");
        ...
        protected void Run(string[] args)
        {
            ...
            for (contador = 1; contador < 10; contador++)
            {
                ...
                //  tratamentoarquivo.Alterar(quantidadekfold);

              
                // 
                training_file = @"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug\Kfold-pasta-" + contador + @"\training.data";
                test_file = @"C:\Users\" + Environment.UserName + @"\Desktop\RecSys\RecSys\RecSys\bin\Debug\Kfold-pasta-" + contador + @"\test.data";
